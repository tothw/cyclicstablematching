...
public class ArrayPreferenceSystem implements PreferenceSystem {
	...
	/* (non-Javadoc)
	 * @see wjtoth.cyclicstablematching.PreferenceSystem#setSystemGroup(int, wjtoth.cyclicstablematching.Group)
	 */
	...
	/* (non-Javadoc)
	 * @see wjtoth.cyclicstablematching.PreferenceSystem#getGroups()
	 */
	...
	/* (non-Javadoc)
	 * @see wjtoth.cyclicstablematching.PreferenceSystem#setGroups(java.util.ArrayList)
	 */
	...
	/* (non-Javadoc)
	 * @see wjtoth.cyclicstablematching.PreferenceSystem#sumAcceptablePartnerCount()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see wjtoth.cyclicstablematching.PreferenceSystem#deepCopy()
	 */
	@Override
	public ArrayPreferenceSystem deepCopy() {
		ArrayPreferenceSystem preferenceSystem = new ArrayPreferenceSystem(groupSizes);
	...
	/* (non-Javadoc)
	 * @see wjtoth.cyclicstablematching.PreferenceSystem#extend()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see wjtoth.cyclicstablematching.PreferenceSystem#filterUnacceptablePartners(wjtoth.cyclicstablematching.Agent)
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see wjtoth.cyclicstablematching.PreferenceSystem#hasStableMatch(wjtoth.cyclicstablematching.CrossProduct)
	 */
	@Override
