...
public class PreferenceSystemNode {
	...
	public PreferenceSystemNode getChild() {
		...
		String hashPostSort = extensionSystem.computeHash();
		++unacceptablePartnersIndex;
		//if hash is unchanged we have canonical preference system
		//otherwise there is a preference system symmetric to this one that can be considered instead
		if(hashPreSort.equals(hashPostSort)|| extensionSystem.size()>15) {
